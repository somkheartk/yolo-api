...
- **[คู่มือการพัฒนา (DEVELOPMENT.md)](DEVELOPMENT.md)** - คู่มือการพัฒนาอย่างละเอียด มี:
  - การติดตั้งและตั้งค่าสภาพแวดล้อม
  - การเตรียมข้อมูลและ annotation
  - การ train โมเดล YOLO แบบละเอียด
  - ตัวอย่างโมเดลและการใช้งาน
  - การทดสอบและ evaluation
  - การปรับแต่งประสิทธิภาพ
  - Best practices

- **[คู่มือการ Deploy (DEPLOYMENT.md)](DEPLOYMENT.md)** - คู่มือการ deploy บน Digital Ocean:
  - การสร้างและตั้งค่า Droplet
  - การติดตั้ง Docker และ dependencies
  - การ deploy application
  - การตั้งค่า domain และ SSL
  - Nginx reverse proxy
  - Firewall และความปลอดภัั
  - Monitoring และ logging
  - Backup และ recovery

- **[ตัวอย่างการใช้งาน (examples/)](examples/)** - ตัวอย่าง code:
  - [Training examples](examples/training/) - ตัวอย่างการ train model
  - [Inference examples](examples/inference/) - ตัวอย่างการใช้งาน API และ YOLO
  - [Dataset tools](examples/datasets/) - เครื่องมือจัดการข้อมูล
